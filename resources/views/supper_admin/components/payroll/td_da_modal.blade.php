        ...
        <div class="modal-content">
            ...
            <form id="advanceSalaryForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="currency" class="font-weight-bold text-dark" style="font-size: 14px;">Currency <span id="currency_rate_info" class="text-danger small font-weight-bold"></span></label>
                    ...
                    <div class="form-group">
                        <label for="attachment" class="font-weight-bold text-dark" style="font-size: 14px;">Attachment(If needed)</label>
