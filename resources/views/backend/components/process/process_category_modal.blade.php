<div class="modal fade" id="modal-center" tabindex="-1" aria-labelledby="modalTitle" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <!-- The Form -->
            <form id="processCategoryForm" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="hidden" id="process_category_id" name="process_category_id" value="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name" class="font-weight-bold text-dark" style="font-size: 14px;">Process Category Name</label>
