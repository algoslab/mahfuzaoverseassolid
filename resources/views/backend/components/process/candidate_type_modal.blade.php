<div class="modal fade" id="modal-center" tabindex="-1" aria-labelledby="modalTitle" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <!-- The Form -->
            <form id="candidateTypeForm" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="hidden" id="candidate_type_id" name="candidate_type_id" value="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name" class="font-weight-bold text-dark" style="font-size: 14px;">Candidate Type Name</label>
