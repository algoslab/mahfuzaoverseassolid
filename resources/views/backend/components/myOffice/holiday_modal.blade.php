<div class="modal fade" id="modal-center" tabindex="-1" aria-labelledby="modalTitle" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <!-- The Form -->
            <form id="holidayFrom" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="hidden" id="holiday_id" name="holiday_id" value="">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name" class="font-weight-bold text-dark" style="font-size: 14px;">Holiday Name</label>
                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter Holiday Name" required>
                    </div>
                    <div class="form-group">
                        <label for="date" class="font-weight-bold text-dark" style="font-size: 14px;">Holiday date</label>
                    ...
                    <div class="row">
                        <div class="form-group bonus-fields col-md-6" style="display: none;">
                            ...
                            <select id="bonous_type" name="bonous_type" class="form-control select2">
