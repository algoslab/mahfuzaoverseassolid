...
<div class="modal fade" id="agentTransactionModal" tabindex="-1" role="dialog" aria-labelledby="agentTransactionModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form id="agentTransactionForm" enctype="multipart/form-data">
      @csrf
      <input type="hidden" name="candidate_id" id="agent_transaction_candidate_id">
      <input type="hidden" name="agent_id" id="agent_candidate_id">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="agentTransactionModalLabel">Make Transaction</h5>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="form-group  col-md-6">
              <label>
                Currency
                <span id="currency_rate_info1" class="text-danger small font-weight-bold"></span>
              </label>
              <select name="currency" class="form-control select2" id="currency_select1">
                <option value="">--Select one--</option>
          ...
          <div class="row">
            <div class="form-group col-md-6">
              <label>Amount</label>
              <input type="number" step="0.01" name="amount" class="form-control" id="amount1" placeholder="Amount">
            </div>
            <div class="form-group  col-md-6">
              <label>BDT Amount</label>
              <input type="number" value="0.00" step="0.01" name="amount_bdt" class="form-control" id="amount_bdt1" readonly>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="form-group">
                <label>Care/of Candidate (If need!)</label>
                <select name="care_candidate_id" class="form-control select2">
                    <option value="">--Select one--</option>
                    @foreach($careCandidates as $key => $candidate)
                        <option value="{{ $candidate->id }}">{{ $candidate->personalInfo->first_name }} {{ $candidate->personalInfo->last_name }}({{ $candidate->candidateType->name }})</option>
                    @endforeach
                </select>
            </div>
          <div class="form-group">
